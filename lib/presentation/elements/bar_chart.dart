...
class BarChartsState extends State<BarCharts> {
  final Color leftBarColor = const Color(0xff577D52);
  ...
  void initState() {
    ...
    final barGroup3 = makeGroupData(2, 16);
    final barGroup4 = makeGroupData(3, 12);
    final barGroup5 = makeGroupData(4, 18);
    final barGroup6 = makeGroupData(5, 22);
